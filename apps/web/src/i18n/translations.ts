...
const zh: Record<string, string> = {
  ...
  "nav.scheduler": "调度管理",
  "nav.schedulerDescription": "监控 cron 调度、tick 健康和 Agent 日程。",
  "nav.alerts": "告警",
  "nav.alertsDescription": "告警管理、过滤和确认中心。",
...
const en: Record<string, string> = {
  ...
  "nav.schedulerDescription": "Monitor cron schedules, tick health, and agent scheduling.",
  "nav.alerts": "Alerts",
  "nav.alertsDescription": "Alert management, filtering, and acknowledgment center.",
